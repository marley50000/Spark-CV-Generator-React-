...
export const GraduationCapIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 011.07 0l3.25 1.5v3.033a1 1 0 00.5.866l1.25.625a1 1 0 001.25 0l1.25-.625a1 1 0 00.5-.866V9.551l3.25-1.5a.999.999 0 011.07 0L19 6.92a1 1 0 000-1.84l-7-3zM3 8.366L10 12l7-3.634V12a1 1 0 01-1 1h-2.5a1 1 0 01-1-1V9.5a1 1 0 00-1-1h-1a1 1 0 00-1 1V12a1 1 0 01-1 1H4a1 1 0 01-1-1V8.366z"/>
    </svg>
);

export const LightbulbIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path d="M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zM15.657 5.657a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM5.05 14.95a1 1 0 001.414 1.414l.707-.707a1 1 0 00-1.414-1.414l-.707.707zM4 10a1 1 0 01-1 1H2a1 1 0 110-2h1a1 1 0 011 1zM10 18a1 1 0 001-1v-1a1 1 0 10-2 0v1a1 1 0 001 1zM8.94 6.553a1 1 0 00-1.88 0l-1.33 4.537A1.5 1.5 0 007.5 13h5a1.5 1.5 0 001.41-1.91L11.06 6.554a1 1 0 00-1.88 0l.06 1.446H8.88l.06-1.447z"/>
    </svg>
);

export const SparklesIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM12 2a1 1 0 01.967.744L14.146 7.2l4.45-1.483a1 1 0 011.214 1.214L18.328 11.4l3.147 1.888a1 1 0 01-.002 1.732l-3.147 1.888-1.483 4.45a1 1 0 01-1.214 1.214L12.7 18.328l-1.888 3.147a1 1 0 01-1.732-.002L7.2 18.328l-4.45 1.483a1 1 0 01-1.214-1.214L2.672 14.1l-3.147-1.888a1 1 0 01.002-1.732L2.672 8.6l1.483-4.45a1 1 0 011.214-1.214L9.8 4.172l1.888-3.147A1 1 0 0112 2z" clipRule="evenodd" />
    </svg>
);
